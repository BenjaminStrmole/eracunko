          ...
          <div className="grid max-w-6xl gap-6 lg:grid-cols-3">
            ...
            <aside className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
              ...
              <div className="mt-6 space-y-4 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-slate-400">Znesek</span>
                  <span>0,00 €</span>
                </div>
                ...
                <div className="flex justify-between border-t border-slate-800 pt-4 font-bold">
                  <span>Skupaj</span>
                  <span>0,00 €</span>
                </div>
              </div>
              ...
              <div className="mt-6 rounded-xl border border-blue-500/20 bg-blue-500/10 p-4 text-sm text-blue-200">
                eSLOG XML bo pripravljen po zaključenem vnosu računa.
              </div>
            </aside>
          </div>
        </section>

...
function normalizeLine(line: InvoiceLine): InvoiceLine {
  ...
  const vatAmount = vatCategory === "S" ? round2(netAmount * (vatRate / 100)) : 0;
...
export function normalizeInvoiceForEslog(invoice: Invoice): Invoice {
  ...
  return {
    ...
    currency: "EUR",
    documentType: invoice.documentType || invoice.eSlog?.documentType || "380",
    businessProcess:
    ...
    seller: invoice.seller
      ? {
          ...
          country: clean(invoice.seller.country || "SI"),
    ...
    buyer: {
      ...
      country: clean(invoice.buyer.country || "SI"),
    ...
    payment: {
      ...
      paymentMeansCode:
        payment.paymentMeansCode || invoice.paymentMeansCode || "30",
    ...
    eSlog: {
      ...
      profileId: invoice.eSlog?.profileId || DEFAULT_PROFILE_ID,
      documentType: invoice.documentType || invoice.eSlog?.documentType || "380",
      businessProcess:
        invoice.businessProcess || invoice.eSlog?.businessProcess || DEFAULT_PROFILE_ID,
      paymentMeansCode:
    ...
    paymentMeansCode:
      invoice.paymentMeansCode || payment.paymentMeansCode || "30",
